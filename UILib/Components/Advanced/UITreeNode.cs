...
namespace UIEditor.UILib.Components.Advanced {
    ...
    public abstract class UITreeNodeDisplay : UIElement {
        public bool IsFolded { get; set; }
        public float LeftOffset { get; set; }
        public bool CanFold { get; set; }
        protected readonly UIImageButton _foldButton;
        public UITreeNodeDisplay() {
            IsFolded = true;
            CanFold = false;
            IsSelected = false;
        ...
        protected void Element_OnClick(Events.UIMouseEvent e, UIElement sender) {
            IsFolded ^= true;
        }
    ...
    public class UITreeNodeTextDisplay : UITreeNodeDisplay {
        public string Text { get { return _label.Text; } set { _label.Text = value; } }

        private readonly UILabel _label;
        public UITreeNodeTextDisplay(string text) : base() {
        ...
        public override void UpdateSelf(GameTime gameTime) {
            base.UpdateSelf(gameTime);
            _label.Position = new Vector2(_foldButton.Position.X + _foldButton.Width + 5, 0);
        }
    ...
    public class UITreeNode : UIElement {
        ...
        public UITreeNode(string text, IList<UITreeNode> nodes) : base() {
            ...
            var display = new UITreeNodeTextDisplay(text) {
